//課題2: ダイクストラ法による最短経路探索 PQDijkstraTester.java

public class PQDijkstraTester{
    public static void main(String[] args) {
        if(args.length != 3){
            System.out.println("Follow this format : java PQDijkstraTester [filename] [startnode] [endnode]");
            System.out.println("Ex) java PQDijkstraTester sample.txt 0 2");
            System.exit(1);
        }
        try{
